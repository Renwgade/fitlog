...
export const EXERCISE_IMAGES: Record<string, string> = {
  "Decline Push-ups": "/assets/exercises/decline_pushup.png",
  "DB Floor Press": "/assets/exercises/db_floor_press.png",
  "Chair Dips": "/assets/exercises/chair_dips.png",
  "DB Shoulder Press": "/assets/exercises/db_shoulder_press.png",
  "DB Lateral Raise": "/assets/exercises/db_lateral_raise.png",
  "Pull-ups": "/assets/exercises/pullups.png",
  "Slow Negative Pull-ups": "/assets/exercises/pullups.png",
  "One-arm DB Row": "/assets/exercises/db_row.png",
  "DB Hammer Curl": "/assets/exercises/db_hammer_curl.png",
  "DB Concentration Curl": "/assets/exercises/db_concentration_curl.png",
  "Goblet Squat": "/assets/exercises/goblet_squat.png",
  "DB Bulgarian Split Squat": "/assets/exercises/bulgarian_split_squat.png",
  "DB Romanian Deadlift": "/assets/exercises/romanian_deadlift.png",
  "Standing Calf Raise": "/assets/exercises/calf_raise.png",
  "Plank": "/assets/exercises/plank.png",
  "Push-ups": "/assets/exercises/pushups.png",
  "DB Row": "/assets/exercises/db_row.png",
  "DB Curl + Triceps Ext": "/assets/exercises/arm_superset.png"
};
  ...
  versions.forEach(v => {
    Object.values(data[v].days).forEach((day: any) => {
      day.exercises = day.exercises.map((ex: any) => ({
        ...ex,
        image: EXERCISE_IMAGES[ex.name] || ex.image,
